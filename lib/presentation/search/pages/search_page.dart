    ...
    return XScaffold(
      body: BlocBuilder<SearchBloc, SearchState>(
        builder: (context, state) {
          ...
          if (data == null || state.status == SearchStatus.failure) {
            return const Center(child: Text('Failed to load search data'));
          }
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 14),
                SearchRecommended(movies: data.recommended),
                ...
                const SizedBox(height: 14),
                SearchTrendingChips(trends: data.trendingSearches),
